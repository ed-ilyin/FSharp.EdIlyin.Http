...
let website = "/FSharp.EdIlyin.Http"

let githubLink = "https://github.com/ed-ilyin/FSharp.EdIlyin.Http"

// Specify more information about your project
let info =
  [ "project-name", "FSharp.EdIlyin.Http"
    "project-author", "Ed Ilyin"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FSharp.EdIlyin.Http" ]
